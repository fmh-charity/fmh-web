...
export const PATIENS_UPDATE_QUERY = "PATIENS_UPDATE_QUERY";
export const PATIENS_CREATE_QUERY = "PATIENS_CREATE_QUERY";
export const PATIENS_DELETE_QUERY = "PATIENS_DELETE_QUERY";
