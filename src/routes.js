...
export const routes = [
  ...
  { Component: StatementPage, path: '/requests', title: "Заявки", icon: <RequestIcon /> },
  ...
  { Component: NewsWindowRoleRead, path: '/newsRoleRead', title: "Новости Роль Чтение", icon: <NewsIcon /> },
